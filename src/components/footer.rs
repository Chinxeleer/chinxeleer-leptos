...
#[component]
pub fn AboutFooter() -> impl IntoView {
    view! {
        <footer class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div class="text-center">
                <div>
                    <a
                        class="flex-none text-4xl font-body font-semibold text-teal-700"
                        href="/"
                        aria-label="Brand"
                    >
                        "chinxeleer"
                        <Icon class="inline w-5 h-5 text-orange-800" icon=i::ChCopyright/>
                    </a>
                </div>
                // <!-- End Col -->
                ...
                <div class="mt-3">
                    <p class="text-gray-500">
                        Made using
                        <a
                            class="text-orange-800 hover:text-teal-800"
